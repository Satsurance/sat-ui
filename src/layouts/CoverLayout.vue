# template section
<template>
  <div class="min-h-[85vh] pt-[5vh] bg-gray-50 py-8">
      ...
      <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <div class="mb-8">
          <div class="space-y-1">
            ...
            <p class="text-gray-500 text-left">Would you like to purchase a cover? We're here to help you explore the future of decentralized insurance.</p>
          </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <!-- Right Column - Helper Links -->
          <div class="flex flex-col space-y-8">
            <div class="space-y-6">
              <p class="font-bold text-center">These links may be helpful for you 🤓</p>
              <div class="space-y-4 ">
                <a
                    href="#"
