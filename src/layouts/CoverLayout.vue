        ...
        <div class="mb-8">
          <div class="space-y-1">
            ...
            <p class="text-gray-500 text-left">
              Would you like to purchase a cover? We're here to help you explore
              ...
              <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                <div class="flex justify-center">
                  ...
                  >
                    ...
                    <template v-else> Apply for Cover </template>
                  </button>
                </div>
              </form>
            </div>
              ...
              <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                <div class="ml-3">
                  ...
                  <h2 class="text-yellow-700">
                    Please try submitting your request again later
                  </h2>
                </div>
              </div>
              <button
