        ...
        <div class="flex justify-between items-center mb-8">
          <div class="space-y-1">
            ...
            <p class="text-gray-500">
              Request test BTC tokens for testing
            </p>
          </div>
        </div>
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                <p class="text-gray-700">
                  Follow <a
                    href="https://support.metamask.io/configure/networks/how-to-add-a-custom-network-rpc/#adding-a-network-manually"
                    target="_blank"
                    class="text-yellow-600 hover:text-yellow-700 underline"
                  >this instruction</a> to add a custom rpc to your metamask wallet. Use <a
                    :href="faucetDetails.rpcPage"
                    target="_blank"
                    class="text-yellow-600 hover:text-yellow-700 underline"
                  >testnet rpc params</a>.
                </p>
              </div>
            </div>
            <div class="flex items-start gap-3">
              ...
              <div>
                <p class="text-gray-700">
                  Visit <a
                    :href="faucetDetails.gasPage"
                    target="_blank"
                    class="text-yellow-600 hover:text-yellow-700 underline"
                  >faucet</a> to get gas tokens for paying transaction fees.
                </p>
              </div>
            </div>
            <div class="flex items-start gap-3">
              ...
              <div>
                <p class="text-gray-700">
                  Request fake BTC tokens using the form below.
                </p>
              </div>
            </div>
            <div class="flex items-start gap-3">
              ...
              <div>
                <p class="text-gray-700 italic ">
                  <strong>Go and test Satsurance functionality!</strong>
                </p>
              </div>
            </div>
          </div>
...
const loadBalances = async () => {
  ...
  currentBTCBalance.value = Number(formatEther(btcBalance)).toFixed(2);
};
