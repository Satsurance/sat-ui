    ...
    <div class="flex flex-col h-full">
      ...
      <div class="flex items-center justify-between mb-4">
        ...
        <span
            ...
            :class="{
            'bg-green-100 text-green-800': product.category === 'Web3',
            'bg-blue-100 text-blue-800': product.category === 'Slashing',
            'bg-purple-100 text-purple-800': product.category === 'Bridges'
          }"
        >
          {{ product.category }}
        </span>
      ...
      <div class="mt-auto">
        ...
        <div class="space-y-2">
          ...
          <div class="flex justify-between text-sm">
            ...
            <span class="text-yellow-600 font-medium">{{ product.annualPercent / 10000 }}% per year</span>
          </div>
        </div>
      </div>
    </div>
