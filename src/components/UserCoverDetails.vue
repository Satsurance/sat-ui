      ...
      <div class="flex min-h-full items-center justify-center p-4">
        ...
        >
          ...
          <div class="space-y-6">
            ...
            <!-- User Address -->
            <div>
              <label class="block text-base text-gray-500 mb-2">Policy Holder</label>
              <div class="flex items-center justify-center gap-2 p-3 bg-gray-50 rounded-lg">
                <span class="font-mono text-sm text-gray-900 whitespace-nowrap overflow-x-auto inline-block">{{ cover.user || "0x0" }}</span>
                <button
                    @click="copyToClipboard(cover.user)"
